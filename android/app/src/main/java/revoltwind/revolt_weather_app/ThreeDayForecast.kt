...
class ThreeDayForecast : AppWidgetProvider() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        if (intent.action == "com.revoltwind.forecast.REFRESH") {
            ...
            val views = RemoteViews(context.packageName, R.layout.three_day_forecast)
    ...
    private fun updateWeatherAppWidget(
        ...
        val refreshIntent = Intent(context, ThreeDayForecast::class.java)
        ...
        val convertIntent = Intent(context, ThreeDayForecast::class.java)
